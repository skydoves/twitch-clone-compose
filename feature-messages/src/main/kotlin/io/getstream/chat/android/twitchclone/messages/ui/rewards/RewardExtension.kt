...
val Reward.background: Color
  inline get() = Color(android.graphics.Color.parseColor(color))

val Reward.iconVector: ImageVector
  inline get() = when (icon) {
    "LockOpen" -> Icons.Default.LockOpen
    "TagFaces" -> Icons.Default.TagFaces
    ...
    else -> Icons.Default.SafetyCheck
  }
